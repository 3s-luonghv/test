...
app.controller('EditModalEvaluateController', function($rootScope, $scope, $uibModalInstance, $http, TitleparentParameter, WebService, ModalService, parentParameter, ValidateUltility) {
...
// user review dropdown
	...
	$scope.saveNclose = function(id) {
		...
		WebService.call($http, "candireview/candireview05", request, function(response) {
