...
app.controller('AddNewModalEvaluateControllerEditor', function($rootScope, $scope, $uibModalInstance, $http, TitleparentParameter, WebService, ModalService, parentParameter, ValidateUltility) {
...
$scope.btnResult2 = function() {
	ModalService.ShowModal('screens/modal/AddNewCatIModal.html', 'AddNewCatIModalController', 'Kết luận', id , function(reponse) {
	 });
};
//modal evaluate
...
$(document).ready(function() {
  $(document).on('change', ".check_class1", function () {
    $(".check_class1").prop("checked", false);
    $(this).prop("checked", true);
  });
});
$(document).ready(function() {
  $(document).on('change', ".check_class2", function () {
    $(".check_class2").prop("checked", false);
    $(this).prop("checked", true);
  });
});
$(document).ready(function() {
  $(document).on('change', ".check_class3", function () {
    $(".check_class3").prop("checked", false);
    $(this).prop("checked", true);
  });
});
$(document).ready(function() {
  $(document).on('change', ".check_class4", function () {
    $(".check_class4").prop("checked", false);
    $(this).prop("checked", true);
  });
});*/
//hết checkbox 
...
$(document).ready(function(){
	...
	function calculateSum() {
		...
		var sum = 0;
		//lặp qua từng input với class txt  và thêm các giá trị
		$(".txt").each(function() {
		...
		// làm tròn tổng cuối cùng thành 2 chữ số thập phân
...
// user review dropdown
	var getDataDropDownUser = function() {
			...
			//gọi để hiển thị data lên drop Level
			WebService.call($http, "user/user03", dataDropDownUser, function(response) {
